...
import com.fridayhouse.snoozz.ext.fade
import com.fridayhouse.snoozz.ext.setAudioAttributesCompat
        ...
        prepare(
          Util.getUserAgent(context, context.packageName).let { userAgent ->
            ProgressiveMediaSource.Factory(DefaultDataSourceFactory(context, userAgent))
              .createMediaSource(MediaItem.fromUri(Uri.parse("asset:///$src")))
          }
        )
      }
  }
