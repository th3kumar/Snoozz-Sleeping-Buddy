package com.fridayhouse.snoozz.playback
...
class PlayerManager(private val context: Context, private val mediaSession: MediaSessionCompat) :
  ...
  //private val analyticsProvider = SnoozzApplication.of(context).getAnalyticsProvider()
...
//  private val castAPIProvider = SnoozzApplication.of(context)
